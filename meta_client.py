...
def get_debug_promoted_objects(market: str) -> list[dict]:
    """SOLO DIAGNÓSTICO: trae, para cada campaña del mercado, el
    promoted_object — ahí Meta guarda EXACTAMENTE a qué evento o
    conversión optimiza esa campaña, en vez de que el código lo adivine
    a partir de las acciones (que resultaron ser ambiguas)."""
    ...
    data = _get(
        ...
        {"fields": "name,objective,promoted_object", "limit": 200},
    )
    return [
        {
            "campaign_name": c.get("name"),
            "objective": c.get("objective"),
            "promoted_object": c.get("promoted_object"),
        }
